base-marionette
===============
[![Build Status](https://magnum.travis-ci.com/UseAllFive/base-marionette.svg?token={{TOKEN}}&branch=development)](https://magnum.travis-ci.com/UseAllFive/base-marionette)
